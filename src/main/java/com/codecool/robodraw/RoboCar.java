 ...
 * @author zoz
 */
public class RoboCar extends JPanel {
    ...
    public void run(String fileName) throws IOException {
        Logger.getLogger(RoboCar.class.getName()).log(Level.INFO, "Initial position of roboCar: {0}, {1}", new Object[]{x, y});
            ...
            if (!line.startsWith("#") && !line.isEmpty()) {
                ...
                if (command1.contentEquals("SET")) {
                    if (command2.contentEquals("X")) {
                        ...
                        Logger.getLogger(RoboCar.class.getName()).log(Level.SEVERE, "Syntax error in the script file!");
                    }
                }
                ...
                if (command1.contentEquals("GO")) {
                    if (command2.contentEquals("STRAIGHT")) {
                        ...
                        while (distanceDone < distanceToGo) {
                            x += ONE_STEP * Math.cos(direction);
                            y += ONE_STEP * Math.sin(direction);
        ...
        Logger.getLogger(RoboCar.class.getName()).log(Level.INFO, "Terminal position of roboCar: {0}, {1}", new Object[]{x, y});
    }
